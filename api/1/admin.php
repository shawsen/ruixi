...
$actionlist = array(
    ...
    'getPageContent' => array(1),   //!< 获取页面内容 
    'savePageContent' => array(1),  //!< 保存页面内容
);
////////////////////////////////////
$uid = $_G['uid'];
...
// 权限管理查询接口
function authQuery(){return C::t('#ruixi#ruixi_auth')->query();}
// 权限设置接口
function authSet(){return C::t('#ruixi#ruixi_auth')->set();}

// 获取页面内容
function getPageContent(){return C::t('#ruixi#ruixi_page')->getContent();}
// 保存页面内容
function savePageContent(){return C::t('#ruixi#ruixi_page')->saveContent();}
