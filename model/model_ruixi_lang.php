...
class model_ruixi_lang
{
    ...
    (/*{{{*/
        ...
        'companyAddr' => '浙江省余姚市舜科路27-29号&nbsp;&nbsp;浙江省杭州市滨江区滨安路1190号智汇中心A座23楼',
        ...
        'home_banner_content' => '宁波睿熙科技有限公司是全球技术领先的 VCSEL 供应商。核心团队成员拥有 20 年在世界一流 VCSEL 公司领导产品设计和生产制造的经验, 涵盖外延生长、工艺制程、芯片设计与模拟、倒片封装、封装、高频测试与设计、大数据分析、失效分析等所有 VCSEL 设计、制造管理领域。公司严格按照世界 500 强质量管理体系要求约束,在生产管理和质量与可靠性上具有国际先进水平的核心竞争力。',
    );/*}}}*/
    ...
    (/*{{{*/
        ...
        'companyAddr' => 'No. 27-29 Shunke Road, Yuyao, Zhejiang, P.R.China&nbsp;&nbsp;No.1190 Bin\'an Road, 23F, Hangzhou, Zhejiang, P.R.China.',
        'companyContact' => '0574-62828223',
        'companyFax' => '0574-62828189',
